...
* Within the folder 'pages': about.html, works.html, hobbies.html, resume.html
* Within the folder 'css': style.css, resume.css
...
* a navigation bar directing the user to access other pages, and
* a footer that contains contact information, links to social media profiles, a link to the LinkedIn profile, and a link to the GitHub profile. 
